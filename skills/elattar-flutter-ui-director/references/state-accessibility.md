...
| --- | --- |
| Loading | Preserve known layout with `DsSkeleton`; use spinner/progress for live work; prevent duplicate submit. |
| Empty | Explain why content is absent and provide the useful next action with `DsEmpty`. |

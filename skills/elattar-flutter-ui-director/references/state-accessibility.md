...
| --- | --- |
| Loading | Preserve known layout with `Skeleton`; use spinner/progress for live work; prevent duplicate submit. |
| Empty | Explain why content is absent and provide the useful next action with `Empty`. |

...
void main() {
  test(
    ...
    () async {
      ...
      final File tokens = _write(source, 'lib/src/foundation/tokens.dart', '''
import 'package:flutter/widgets.dart';

const Color shotFixtureInk = Color(0xFF101010);
''');
      final File panel = _write(source, 'lib/src/components/panel.dart', '''
import 'package:flutter/widgets.dart';
...
''');
      ...
      _manifest(source, 'registry/components/panel.json', <String, Object?>{
        ...
        'files': <Object?>[
          _fileEntry(panel, 'lib/src/components/panel.dart', '@ui/panel.dart'),
        ],
        'registryDependencies': <String>['source-foundation'],
        'documentationRoute': '/components/panel',
      });
      _manifest(source, 'registry/shots/console-shot.json', <String, Object?>{
        'name': 'console-shot',
        'type': 'shot',
        ...
        'files': <Object?>[
          _fileEntry(
            consoleShot,
            'lib/shots/console/console_shot.dart',
            '@app/shots/console/console_shot.dart',
          ),
        ],
        'registryDependencies': <String>['panel'],
        'documentationRoute': '/shots/console',
      });
      _manifest(source, 'registry/shots/minimal-shot.json', <String, Object?>{
        'name': 'minimal-shot',
        'type': 'shot',
        ...
        'files': <Object?>[
          _fileEntry(
            ...
            '@app/shots/minimal_shot.dart',
          ),
        ],
        'registryDependencies': <String>['panel'],
        'documentationRoute': '/shots/minimal',
      });
      ...
      // The shot payload must land under the `app` logical folder.
      expect(
        File(
          '$registryPath/versions/console-shot/0.0.1/logical/app/shots/console/console_shot.dart',
        ).existsSync(),
        isTrue,
      );
...
''');
      ...
      final File installedConsole = File(
        '${consumer.path}/lib/shots/console/console_shot.dart',
      );
      final File installedMinimal = File(
        '${consumer.path}/lib/shots/minimal_shot.dart',
      );

/// `foil-value` — the premium Button's surface (`app/globals.css` L1948–2040),
...
// the body glow.
//
// allow-hardcoded: foil-value gradient geometry (globals.css L1964–2030)
...
class DsFoilValue extends StatefulWidget {
  ...
  /// multiply/screen split `sheen-action::before` needs. It is listed there
...
// them. `sheen_action.dart` carries the same four verbatim: the plan's

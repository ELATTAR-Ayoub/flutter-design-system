...
/// [TextStyles.buttonLabel] (13 / 18.5714 / 500) and the weekday header is
/// `text-sm font-normal` → [TextStyles.bodySmall] (13 / 18.5714 / 400). Both
...
class CalendarTextStyles {
  ...
  static final TextStyleToken dayNumber = TextStyleToken(
    family: Fonts.sans,
    size: 16,
    height: 1,
    wght: 400,

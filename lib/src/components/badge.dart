...
/// none of them. The `has-data-[icon=inline-*]` padding trims wait for a call
/// site that renders an icon; nothing in the corpus does.
library;
...
class DsBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget content = Padding(
      ...
      child: Center(
        widthFactor: 1,
        child: DsText(label, DsComponentType.badgeLabel, color: _ink(theme)),
      ),
    );

...
/// not `DsInputGroup`'s 50 (inputs-map drift 7).
...
class DsTextarea extends StatefulWidget {
  ...
  /// `aria-invalid`. ORed with the enclosing [DsFieldScope]'s, and it beats
  ...
  static double get minHeight => ds(20);

  /// `px-3.5 py-2.5` — 14px / 10px.
  static EdgeInsets get insets =>
      EdgeInsets.symmetric(horizontal: ds(3.5), vertical: ds(2.5));
...
class _DsTextareaState extends State<DsTextarea> {
  ...
  @override
  void didUpdateWidget(DsTextarea old) {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle textStyle =
        DsText.styleOf(context, DsComponentType.textareaBody);
    ...
    final Widget editable = EditableText(
      ...
      // needs and [DsTextarea.minHeight] is the floor under it.
      maxLines: null,
      minLines: null,
    ...
    body = ConstrainedBox(
      ...
      constraints: BoxConstraints(minHeight: DsTextarea.minHeight),
      child: DsFieldSurface(
        radius: BorderRadius.circular(DsRadii.lg),
        focused: _focused,
        invalid: invalid,
        child: Padding(padding: DsTextarea.insets, child: body),
      ),
    );

...
/// never touches a `.type-*` class, which is why [TextStyles.fieldLabel],
/// [TextStyles.bodySmall] and [TextStyles.small] are three different specs here
/// rather than one.
///
/// ## The wiring contract
///
...
class FieldLegend extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // typing a third — the size and weight are [TextStyles.fieldLabel]'s,
    // the leading is [TextStyles.bodySmall]'s.
    final TextStyle style = StyledText.styleOf(
      context,
      TextStyles.fieldLabel,
    ).copyWith(height: TextStyles.bodySmall.height);
    return Align(
...
class FieldLabel extends StatelessWidget {
  ...
  /// moves.
  ///
  /// **The weight is borrowed from [TextStyles.bodySmall], not typed.**
  ...
  /// out of the token guard's way. Same composition [FieldLegend] performs one
  ...
  static final TextStyleToken normal = TextStyleToken(
    family: TextStyles.fieldLabel.family,
    size: TextStyles.fieldLabel.size,
    height: TextStyles.fieldLabel.height,
    wght: TextStyles.bodySmall.variations.first.value,
  );
  ...
  Widget build(BuildContext context) {
    ...
    // turns into two.
    Widget label = StyledText(text, spec ?? TextStyles.fieldLabel);
...
class FieldDescription extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StyledText(text, TextStyles.small, align: TextAlign.start);
  }
}
...
class FieldError extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    StyledText ink(String message) =>
        StyledText(message, TextStyles.bodySmall, color: theme.destructiveText);

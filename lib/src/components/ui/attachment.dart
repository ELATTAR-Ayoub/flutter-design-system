    ...
    return AttachmentScope(
      ...
      child: DefaultTextStyle.merge(
        ...
        style: StyledText.styleOf(
          context,
          widget.size == AttachmentSize.md
              ? TextStyles.attachmentTitle
              : TextStyles.attachmentTitleSmall,
...
class _ShimmerTextState extends State<AttachmentStatusText>
  ...
  void didChangeDependencies() {
    ...
    if (effectiveMotionDuration(context, AttachmentStatusText.period) == Duration.zero) {
      _c.stop();
      _c.value = 0;
  ...
  Widget build(BuildContext context) {
    ...
    final double fontSize =
        StyledText.styleOf(context, TextStyles.attachmentTitleSmall).fontSize ??
        12;
    ...
    final double spread =
        AttachmentStatusText.spreadChars * fontSize * 0.6455 + AttachmentStatusText.spreadPx;
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) => ShaderMask(
        ...
        shaderCallback: (Rect bounds) {
          ...
          final double radians = AttachmentStatusText.angleDegrees * math.pi / 180;
...
class AttachmentDescription extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: StyledText(
        text,
        TextStyles.attachmentDescription,

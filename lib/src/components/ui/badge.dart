...
class Badge extends StatelessWidget {
  ...
  /// Overrides [TextStyles.badgeLabel].
  ///
  /// `SidebarMenuBadge` writes `.type-num-xs` onto the chip, which resolves to
  /// [TextStyles.sidebarMenuBadge] rather than to the class it names —
  ...
  static double get height => space(5);

...
class _MdType {
  ...
  static final TextStyleToken strong = TextStyleToken(
    family: Fonts.sans,
    size: TextStyles.body.size,
    height: relaxed,
    wght: 600,
  ...
  static final TextStyleToken emphasis = TextStyleToken(
    family: Fonts.sans,
    size: TextStyles.body.size,
    height: relaxed,
    wght: 400,
  ...
  static final TextStyleToken cellTabular = TextStyleToken(
    family: Fonts.sans,
...
class AgentCodeBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double strut =
        StyledText.styleOf(context, _MdType.body).fontSize! * _MdType.relaxed;

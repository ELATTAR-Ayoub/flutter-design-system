...
Widget _page(Form form, {Widget? cta, ScrollController? scrollController}) => _host(
  FormScope(
    form: form,
...
Form _form() => Form(
  fields: <FormFieldBase>[
    TextFormField(name: 'email', initialValue: '', rules: <ValidationRule<String>>[ValidationRule.minLength(1, 'Enter your email')]),
    TextFormField(name: 'handle', initialValue: '', rules: <ValidationRule<String>>[ValidationRule.minLength(1, 'Pick a handle')]),
  ],
);

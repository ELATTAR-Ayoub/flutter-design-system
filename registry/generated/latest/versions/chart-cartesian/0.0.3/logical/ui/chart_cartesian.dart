      ...
      if (horizontal) {
        xTicks.addAll(
          _preserveEndTicks(
            ...
            isNumeric: <bool>[
              for (int i = 0; i < n; i++) widget.data[i][categoryKey] is num,
            ],
    ...
    return Transform.translate(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          // measured from.
          // Flexible in every branch: the offset that places the tick is a
          // fixed part of the row, and at 200% text the label beyond it can be
          // wider than the axis is. A tick that will not fit shortens; it does
          // not paint past the plot.

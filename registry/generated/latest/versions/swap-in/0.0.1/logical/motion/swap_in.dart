...
/// is what [ElKeyframeFill.both] already gives the player.
library;
...
class ElSwapIn extends StatelessWidget {
  const ElSwapIn({super.key, required this.child, this.replayKey});
  ...
  static Duration get duration => ElDurations.base;

  /// `var(--ease-spring)`.
  static Curve get curve => ElCurves.spring;

  @override
  Widget build(BuildContext context) => ElKeyframePlayer(

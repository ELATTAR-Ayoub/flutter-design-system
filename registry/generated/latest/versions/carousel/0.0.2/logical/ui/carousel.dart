...
/// them — [Carousel] asks for its own horizontal padding and grows its stack
...
/// browser's behaviour exactly. Compare `HitArea`, which exists for the
...
class _CarouselState extends State<Carousel>
  ...
  late final CarouselController _controller = CarouselController(vsync: this);
  final FocusNode _focus = FocusNode(debugLabel: 'Carousel');
  ...
  Widget build(BuildContext context) {
    ...
    // The engine has no `Duration` to hand [effectiveMotionDuration]; the reduced
...
/// plus `rounded-full`, which a [Button] is already.
      ...
      builder: (BuildContext context, _) {
        ...
        return Button(
          ...
          onPressed: enabled
              ...
              : null,
          child: Icon.lucide(
            forward ? Lucide.chevronRight : Lucide.chevronLeft,

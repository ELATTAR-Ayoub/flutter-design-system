...
/// off the end. [ElProgress] therefore translates, exactly as written.
///
...
enum ElProgressTone {
  ...
  String get label => this == ElProgressTone.normal ? 'default' : name;

  /// `bg-<x>-ink` — the fill.
  Color inkOf(ElThemeData theme) => switch (this) {
    ElProgressTone.normal => theme.actionInk,
    ElProgressTone.value => theme.valueInk,
    ElProgressTone.success => theme.successInk,
    ElProgressTone.warning => theme.warningInk,
    ElProgressTone.destructive => theme.destructiveInk,
  };
  ...
  /// shadow.
  ElShadowSpec get shadow => switch (this) {
    ElProgressTone.normal => ElShadows.btnPrimary,
    ElProgressTone.value => ElShadows.btnValue,
    ElProgressTone.success ||
    ElProgressTone.warning ||
    ElProgressTone.destructive => ElShadows.btn,
  };
}
...
class ElProgress extends StatelessWidget {
  ...
  static double get height => el(2.5);
  ...
  /// is [ElDurations.transitionDefault], not [ElDurations.base] — two
  /// declarations that agree at 250ms today. Measured on the live page as
  /// `transform 250ms cubic-bezier(0.22, 1, 0.36, 1)`.
  static Duration get transition => ElDurations.transitionDefault;
        ...
        child: ElMachineSurface(
          ...
          child: ClipRRect(
            ...
            child: _AnimatedFractionalTranslation(
              ...
              duration: elAnimationDuration(context, transition),
              curve: ElCurves.out,
...
///
/// Private: it is [ElProgress]'s own plumbing, not a component, and the barrel

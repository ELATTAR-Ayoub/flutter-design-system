...
class Input extends StatefulWidget {
  ...
  /// contributes only what it alone declares. [TextStyles.numberBase] and
  /// [TextStyles.identifier] are those two collapses already resolved in
  /// the foundation layer; passing [TextStyles.numberBase] here would render 15px and
  /// be wrong by two pixels.
  ///
  /// Defaults to [TextStyles.body] — the bare `text-sm`, 13/400.

...
class Accordion extends StatelessWidget {
  ...
  /// [Tabs]' reason — the list is positional and an `indexWhere` miss would
...
class _AccordionTrigger extends StatefulWidget {
  ...
  @override
  State<_AccordionTrigger> createState() => _AccordionTriggerState();
}

class _AccordionTriggerState extends State<_AccordionTrigger> {
  bool _hovered = false;
  bool _focused = false;
  ...
  Widget build(BuildContext context) {
    ...
    // The ring below is the trigger's own — a `Surface` spec rather than a
    // painted outline — so `Press` is asked for the contract and not for the
    // decoration: Tab, Enter, Space, a named and expanded button, and a 44px
    // target under a 40.56px row.
    return Press(
      onTap: widget.onTap,
      semanticLabel: widget.title,
      expanded: widget.expanded,
      showFocusRing: false,
      onHoverChange: _hover,
      onFocusChange: (bool value) => setState(() => _focused = value),
      child: Builder(
        builder: (BuildContext context) {
          return TweenAnimationBuilder<Color?>(
            tween: ColorTween(end: _focused ? theme.ring : transparent),
            duration: transition,
              ...
              return Surface(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(
                    vertical: Accordion.triggerPaddingY,
                  ),
                  child: Row(
                      ...
                      Expanded(
                        child: Builder(
                          builder: (BuildContext context) {
                            ...
                            // that has to ask for [LineBox] by hand, where
                            // [StyledText] would have brought it.

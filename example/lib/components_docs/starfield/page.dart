...
///
/// **Why `EffectSection`, not `ShowcaseSection`.** [ElStarfield] renders
...
/// `EffectSection.minHeight: el(160)` — a starfield judged in the kit's
...
final ComponentDocSpec starfieldDocSpec = ComponentDocSpec(
  ...
  sections: <DocsPageSection>[
    EffectSection(
      ...
      title: 'Preview',
      description:
          'The left panel mounts ElStarfield(bloom2: ElPalette.action) as '
    ...
    InstallSection(
      ...
      title: 'Installation',
      description:
          'starfield has a real registry manifest: `elattar add starfield` '
          'installs lib/src/effects/starfield.dart and resolves its two '
          'registryDependencies automatically. The Manual tab is for a '
          'project not using the CLI.',
      command: starfieldDoc.command,
      manualFiles: <DocsCodeFile>[
        DocsCodeFile(
          path: 'lib/effects/starfield.dart',
          title: '1. Copy the source',
          description:
              "Copy lib/src/effects/starfield.dart's generated "
              '@effects/starfield.dart payload into effects.',
          code:
              "import 'package:elattar_design_system/elattar_design_system.dart';\n\n"
        ...
        DocsCodeFile(
          ...
          description:
              'Add the export line so ElStarfield, ElStarfieldCluster and '
              'ElSparkle are reachable the same way the CLI path already '
              'makes them.',
    ...
    SnippetSection(
      ...
      title: 'Usage',
      description:
          'ElStarfield paints over the whole of its box: give it tight '
    ...
    EffectSection(
      ...
      description:
          ...
          'about the cluster\'s own anchored corner — on ElDurations.bloom '
          '(1000ms), independently of the sway that keeps running '
          'underneath it.',
      host: _StarfieldHost(width: el(68), height: el(48)),
      code: _hoverCode,
    ...
    DisclosureSection(
      ...
      title: 'API Reference',
      description:
          'Every constructor parameter ElStarfield declares, and every '
          'field of the two data records it is built from.',
      children: const <DocsTocEntry>[
        DocsTocEntry(title: 'ElStarfield', anchor: 'api-elstarfield'),
        DocsTocEntry(
          title: 'ElStarfieldCluster',
          anchor: 'api-elstarfieldcluster',
        ),
        DocsTocEntry(title: 'ElSparkle', anchor: 'api-elsparkle'),
      ],
      ...
      child: DocsInstallFacts(
        ...
        facts: <DocsInstallFact>[
          ...
          const DocsInstallFact(
            ...
            description:
                'Groups "ElStarfield — the two clusters" and "the '
...
class StarfieldDocPage extends StatelessWidget {
  const StarfieldDocPage({super.key, this.onNavigate});

  final ValueChanged<String>? onNavigate;

  @override
  Widget build(BuildContext context) => DocsLayout(
    route: starfieldDoc.route,
    intro: DocsPageIntro(
      eyebrow: 'COMPONENTS / EFFECTS',
      title: starfieldDoc.title,
      description: starfieldDoc.description,
    ),
    breadcrumbs: const <ElBreadcrumbEntry>[
      ElBreadcrumbEntry.link('Components'),
      ElBreadcrumbEntry.page('Starfield'),
    ],
...
/// A themed panel with [ElStarfield] hung over it as a `Positioned.fill`
  ...
  Widget build(BuildContext context) => Wrap(
    ...
    children: <Widget>[
      Column(
        ...
        children: <Widget>[
          _caption(context, 'With ElStarfield'),
      ...
      Column(
        ...
        children: <Widget>[
          ...
          KeyedSubtree(
            ...
            child: _PlainPanel(width: el(68), height: el(48)),
          ),
        ],
      ),
    ],
...
const String _previewCode =
    '// With ElStarfield — the effect this page documents\n'
    'Stack(\n'
    '  fit: StackFit.expand,\n'
    '  children: [\n'
    '    Positioned.fill(\n'
    '      child: ElStarfield(bloom2: ElPalette.action),\n'
    '    ),\n'
    '  ],\n'
    ')\n\n'
    '// Without — the identical DecoratedBox, no ElStarfield at all\n'
...
const String _hostHeightCode =
    ...
    '    fit: StackFit.expand,\n'
    '    children: [\n'
    '      Positioned.fill(child: ElStarfield(bloom2: ElPalette.action)),\n'
    '    ],\n'
    '  ),\n'
    ')';
...
const String _hoverCode =
    ...
    '    children: [\n'
    '      Positioned.fill(\n'
    '        child: ElStarfield(bloom2: ElPalette.action, hovered: hovered),\n'
    '      ),\n'
    '    ],\n'
    '  ),\n'
    ')';
...
Stack(
  ...
  children: [
    Positioned.fill(
      child: ElStarfield(bloom2: theme.actionInk, hovered: hovered),
    ),
    child,
  ],
)''';
...
class _ApiReferenceContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: <Widget>[
      const DocsAnchor(
        id: 'api-elstarfield',
        child: DocsApiTable(title: 'ElStarfield', facts: _starfieldApiFacts),
      ),
      ...
      const DocsAnchor(
        ...
        child: DocsApiTable(
          title: 'ElStarfieldCluster',
          facts: _clusterApiFacts,
        ),
      ),
      SizedBox(height: el(6)),
      const DocsAnchor(
        id: 'api-elsparkle',
        child: DocsApiTable(title: 'ElSparkle', facts: _sparkleApiFacts),
      ),
    ],
  );
}
...
class _AccessibilityContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      _bullets(ElTheme.of(context), <String>[
        'ElStarfield wraps its whole CustomPaint in IgnorePointer and adds '
...
class _KeyboardContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      _bullets(ElTheme.of(context), <String>[
        'ElStarfield takes no focus and handles no key: there is no Focus, '
        ...
        'The hover it reacts to is not its own, either — hovered is a '
            ...
            'ElStarfield\'s IgnorePointer keeps it from ever seeing a '
  ...
  Widget build(BuildContext context) =>
      _bullets(ElTheme.of(context), <String>[
        ...
        'What does vary with size is the host\'s own geometry, not the '
            ...
            'a property of the box ElStarfield is given — see Host Height '
...
class _DependenciesContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: <Widget>[
      _bullets(ElTheme.of(context), <String>[
        'File: lib/src/effects/starfield.dart — one file, three classes, '
            'no companions.',
        'Flutter imports: dart:math, dart:ui, foundation.dart (@immutable, '
            '@visibleForTesting, listEquals), widgets.dart.',
        'Foundation imports: ../components/icon_paths.dart (ElIconPaths, '
            'the sparkle path and its viewBox), foundation/colors.dart '
            '(elHsl, ElOklab), foundation/motion.dart (elAnimationDuration, '
            'ElDurations, ElCurves), foundation/theme.dart, theme_scope.dart.',
        'registryDependencies, resolved automatically by `elattar add '
            'starfield`: icon, source-foundation — copied verbatim from '
            'registry/effects/starfield.json.',
        'Not a dependency of starfield.dart itself, but its one real '
            'consumer in the corpus: ElBloomCosmic mounts ElStarfield '
...
const List<DocsApiFact> _clusterApiFacts = <DocsApiFact>[
  ...
  DocsApiFact(
    ...
    type: 'Duration',
    description:
        'animation-duration for the rotation: ElDurations.sway (44s) on '
        'the dense cluster, ElDurations.swayAlt (33s) on the thin one — '
...
const List<DocsStateFact> _stateFacts = <DocsStateFact>[
  ...
  DocsStateFact(
    ...
    treatment:
        ...
        'origin, over ElDurations.bloom (1000ms) on ElCurves.out.',
    userSignal:
  ...
  DocsStateFact(
    ...
    treatment:
        'elAnimationDuration(context, ElDurations.sway) resolves to '

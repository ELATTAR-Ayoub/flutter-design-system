...
///
/// **Split from toggle-group.** This entry used to describe both `ElToggle`
/// and `ElToggleGroup` on one page. They are two separately barrel-exported
...
/// `ElToggle` and the two enums it owns, `ElToggleVariant` and `ElToggleSize`.
...
const ComponentDocEntry toggleDoc = ComponentDocEntry(
  ...
  exports: <String>['ElToggle', 'ElToggleVariant', 'ElToggleSize'],

...
/// rest — that opens whatever is passed as [ElAgentLauncher.child] in a
...
const ComponentDocEntry agentLauncherDoc = ComponentDocEntry(
  ...
  description:
      'A fixed-position entrance to the agent: the same face the console '
  ...
  exports: <String>['ElAgentLauncher'],

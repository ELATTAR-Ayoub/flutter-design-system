...
/// copied verbatim: `button`, `field`, `machine-surface`, `source-foundation`.
...
/// `ElSection` rather than declared as a `ComponentDocSpec`. It has moved
...
const ComponentDocEntry inputDoc = ComponentDocEntry(
  ...
  dependencies: <String>['button', 'field', 'machine-surface', 'source-foundation'],
  exports: <String>['ElInput', 'ElFieldSurface', 'ElFieldVisibility'],

...
/// `StatelessWidget`, `MediaScrim`, with exactly one constructor
  ...
  sections: <DocsPageSection>[
    EffectSection(
      ...
      description:
          ...
          'behind an MediaScrim. The gradient is fully transparent at '
          'the top (stops[0] = 0, alpha 0) and reaches '
          'MediaScrimTokens.bottomAlpha (0.82) by the bottom edge, so '
    ...
    InstallSection(
      ...
      description:
          ...
          'media-scrim` installs lib/src/components/ui/media_scrim.dart and '
    ...
    SnippetSection(
      ...
      description:
          ...
          'for why it is a sibling rather than MediaScrim.child.',
      code: _usageCode,
    ),
    EffectSection(
      id: 'overlaid-copy',
      title: 'Overlaid Copy',
      description:
          'showcase_reels.dart\'s own arrangement: MediaScrim(child: '
          ...
          'it, styled with MediaScrimTokens.foreground so the text '
    ...
    DisclosureSection(
      ...
      title: 'API Reference',
      description:
          'MediaScrim\'s own constructor parameter, plus the '
          'foundation-owned MediaScrimTokens fields this effect reads '
      ...
      children: const <DocsTocEntry>[
        DocsTocEntry(title: 'MediaScrim', anchor: 'api-elmediascrim'),
        DocsTocEntry(
          title: 'MediaScrimTokens',
...
class MediaScrimDocPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => DocsLayout(
    ...
    breadcrumbs: const <BreadcrumbEntry>[
      ...
      BreadcrumbEntry.page('Media Scrim'),
    ],
...
class _PreviewHost extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _CaptionedPair(
    ...
    rightCaption: 'Behind an MediaScrim',
    right: _MediaStandIn(
...
const String _previewCode =
    ...
    '      child: Text(\n'
    "        'Late-night skyline',\n"
    '        style: TextStyle(color: MediaScrimTokens.foreground),\n'
    '      ),\n'
    '    ),\n'
    '  ],\n'
    ')';
...
class _ApiReferenceContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: <Widget>[
      const DocsAnchor(
        id: 'api-elmediascrim',
        child: DocsApiTable(title: 'MediaScrim', facts: _apiFacts),
      ),
      SizedBox(height: space(6)),
      const DocsAnchor(
        id: 'api-elmediascrimtokens',
        child: DocsApiTable(
          title: 'MediaScrimTokens (foundation/media.dart)',
          facts: _tokensFacts,
        ),
      ),
    ],
...
const List<DocsApiFact> _tokensFacts = <DocsApiFact>[
  DocsApiFact(
    ...
    type: 'static Color',
    description:
        'A theme-independent neutral (hslColor(0, 0, 0) — pure black in '
  ...
  DocsApiFact(
    ...
    description:
        ...
        '(hslColor(0, 0, 100) — pure white in both themes): media\'s '
...
class _StatesContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      _bullets(ThemeScope.of(context), <String>[
        'MediaScrim is a StatelessWidget: no hover, press, focus, or '
...
class _AccessibilityContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      _bullets(ThemeScope.of(context), <String>[
        'MediaScrim renders no Semantics node of its own: build() '
        ...
        'It carries no accessible name and defines no role: it is a '
            ...
            'caller exactly as showcase_reels.dart\'s own StyledText does.',
      ]);
}
...
class _KeyboardContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      _bullets(ThemeScope.of(context), <String>[
        'MediaScrim takes no focus and handles no key: media_scrim.dart '
...
class _DependenciesContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: <Widget>[
      _bullets(ThemeScope.of(context), <String>[
        'File: lib/src/components/ui/media_scrim.dart: one file, one class, no '
            'companions.',
        'Flutter imports: package:flutter/widgets.dart only.',
        'Foundation imports: foundation/media.dart (MediaScrimTokens). '
            'The same file also declares AspectRatios.portrait, a '
            'separate 9:16 aspect-ratio contract this effect does not '
            'read.',
        'registryDependencies, resolved automatically by `elattar add '
            'media-scrim`: source-foundation — copied verbatim from '
            'registry/components/media-scrim.json. No semanticDependencies.',
...
class _ThemingContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      _bullets(ThemeScope.of(context), <String>[
        'MediaScrim never calls ThemeScope.of(context): its gradient is '
            'built entirely from MediaScrimTokens, and every one of '
            'those fields is a plain Color or double, not a Color '
            'Function(ThemeTokens) the way an ShadowLayer is.',
        'That is deliberate, per the token class\'s own doc: "Media does '
            ...
            '(hslColor(0, 0, 0)) and foreground (hslColor(0, 0, 100)) render '
            'identically whether ThemeController is set to light or '
            'dark.',
        'The one thing that DOES flip with the app theme is whatever '
            'sits outside the scrim — the surrounding chrome, any '
            'StyledText not styled with MediaScrimTokens.foreground — but '

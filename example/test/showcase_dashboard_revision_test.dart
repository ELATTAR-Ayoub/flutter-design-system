...
void main() {
  testWidgets('dashboard gives the hero and chart distinct visual hierarchy', (
    ...
    await _pumpDashboard(tester, size: const Size(Breakpoints.lg, 900));
    ...
    expect(find.byType(Stat), findsNWidgets(4));
    expect(find.byType(ItemGroup), findsNWidgets(2));
  ...
  testWidgets('compact dashboard content scrolls clear of the fixed dock', (
    ...
    final Finder dock = find.ancestor(
      ...
      matching: find.byWidgetPredicate(
        (Widget widget) =>
            widget is Glass && widget.variant == GlassVariant.navigation,
      ),
    );
    expect(

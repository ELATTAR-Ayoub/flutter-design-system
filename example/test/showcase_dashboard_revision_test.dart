...
void main() {
  testWidgets('dashboard gives the hero and chart distinct visual hierarchy', (
    ...
    await _pumpDashboard(tester, size: const Size(DsBreakpoints.lg, 900));
    ...
    expect(find.byType(DsStat), findsNWidgets(4));
    expect(find.byType(DsItemGroup), findsNWidgets(2));

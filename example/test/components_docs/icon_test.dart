...
void main() {
  group('icon, spinner, ds-rule docs page', () {
    testWidgets(
      'renders the article with icon specimens at multiple sizes',
    ...
    testWidgets(
      'spinner rotates under normal motion',
      (WidgetTester tester) async {
        tester.view.physicalSize = const Size(1440, 900);
        tester.view.devicePixelRatio = 1;
        addTearDown(tester.view.reset);
        ...
        final RotationTransition rotation1 = tester
            .widget<RotationTransition>(rotationFinder.first);
        final double value1 = rotation1.turns.value;

        // Pump again at 100ms.
        await tester.pump(const Duration(milliseconds: 100));

        final RotationTransition rotation2 = tester
            .widget<RotationTransition>(rotationFinder.first);
    ...
    testWidgets(
      'icon sizes and tones resolve correctly in both themes',
      (WidgetTester tester) async {
        tester.view.physicalSize = const Size(1440, 900);
        tester.view.devicePixelRatio = 1;
        addTearDown(tester.view.reset);
    ...
    testWidgets(
      'ds-rule validation runs without error',
      (WidgetTester tester) async {
        tester.view.physicalSize = const Size(1440, 900);
        tester.view.devicePixelRatio = 1;
        addTearDown(tester.view.reset);
        ...
        // oneOf rule.
        final DsRule<String?> oneOfRule = DsRule.oneOf(
        ...
        // Dedupe.
        final List<String> deduped = DsRules.dedupe(
          <String>['msg1', 'msg2', 'msg1'],
        );
